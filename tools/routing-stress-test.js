...
var tests = [
  ...
  ["I've completely lost my purpose in life", "", "sadness", "lost my purpose → sadness"],
  ["I have no sense of purpose anymore", "", "sadness", "no sense of purpose → sadness"],
  ["I really let myself down this time", "", "shameGuilt", "let myself down → shameGuilt"],
  ["I feel like I let everyone down with my choices", "", "shameGuilt", "let everyone down → shameGuilt"],
  ["my manager keeps holding me back from the promotion", "", "anger", "holding me back → anger"],
  ["all that hard work finally paid off and I'm overjoyed", "", "positive", "paid off → positive"],

  // R159: sadness (dead inside), anger (invaded my privacy), techniques (diaphragmatic breathing), positive (overcame), overwhelm (plate is full)
  ["I feel completely dead inside and can't feel anything", "", "sadness", "dead inside → sadness"],
  ["someone invaded my privacy and I'm furious about it", "", "anger", "invaded my privacy → anger"],
  ["I've been practising diaphragmatic breathing every morning", "", "techniques", "diaphragmatic breathing → techniques"],
  ["belly breathing is a new technique I'm exploring", "", "techniques", "belly breathing → techniques"],
  ["I overcame a challenge today that I'm really proud of", "", "positive", "overcame a challenge → positive"],
  ["my plate is full and I don't know what to drop", "", "overwhelm", "my plate is full → overwhelm"],

  // R158: shameGuilt (regret), positive (making memories/cherish), sadness (miss my old life), relax (release tension)
  ["I live with so much regret and it weighs on me", "", "shameGuilt", "regret → shameGuilt"],
  ["there's deep regret inside me I can't shake", "", "shameGuilt", "deep regret → shameGuilt"],
  ["I miss my old life before everything changed", "", "sadness", "miss my old life → sadness"],
  ["I miss who I used to be before all this", "", "sadness", "miss who I used to be → sadness"],
  ["I just want to release tension from my body and mind", "", "relax", "release tension → relax"],
  ["We are making memories that will last a lifetime", "", "positive", "making memories → positive"],
  ["I cherish every moment I spend with loved ones", "", "positive", "cherish → positive"],

  // R157: anger (feel controlled), focus (momentum), sadness (can't express myself), relax (claustrophobia)
  ["I feel controlled by my partner and it makes me furious", "", "anger", "feel controlled → anger"],
  ["I feel like I'm being controlled and it's suffocating", "", "anger", "feel like I'm being controlled → anger"],
  ["I can't maintain momentum on any of my projects", "", "focus", "can't maintain momentum → focus"],
  ["I keep starting over and never building momentum", "", "focus", "keep starting over → focus"],
  ["I can't express myself and it's so frustrating", "", "sadness", "can't express myself → sadness"],
  ["I don't know how to express what I'm feeling", "", "sadness", "don't know how to express → sadness"],
  ["I have real claustrophobia and it's getting worse", "", "relax", "claustrophobia → relax"],
  ...
  ["I've reached a milestone I never thought I'd reach", "", "positive", "reached a milestone → positive"],
  ["he completely crossed a line and I'm furious", "", "anger", "crossed a line → anger"],
  ["he crossed the line and I cannot forgive it", "", "anger", "crossed the line → anger"],
  ["I keep crying for no reason and it worries me", "", "sadness", "crying for no reason → sadness"],
  ["I've been reading about behavioral activation", "", "techniques", "behavioral activation → techniques"],
  ["I'm completely in over my head at work", "", "overwhelm", "in over my head → overwhelm"],
  ["I'm way out of my depth in this situation", "", "overwhelm", "out of my depth → overwhelm"],

  // R153: energy (running on fumes), sadness (emotional shutdown), relax (heart pounding), shameGuilt (cheated in exam/plagiarism)
  ["I'm completely running on fumes by this point", "", "energy", "running on fumes → energy"],
  ["I've gone into emotional shutdown today", "", "sadness", "emotional shutdown → sadness"],
  ["I keep shutting down emotionally in arguments", "", "sadness", "shutting down emotionally → sadness"],
  ["my heart is pounding and I can't calm down", "", "relax", "heart pounding → relax"],
  ["I cheated in an exam last week and feel awful", "", "shameGuilt", "cheated in an exam → shameGuilt"],
  ["I committed plagiarism and it's haunting me", "", "shameGuilt", "plagiarism → shameGuilt"],
  ...
  ["I feel shattered after what happened", "", "sadness", "shattered → sadness"],
  ["I'm always the one who gets scapegoated at work", "", "anger", "scapegoated → anger"],
  ["I always end up as the scapegoat in my family", "", "anger", "the scapegoat → anger"],
  ["I'm always playing catch-up and it never ends", "", "overwhelm", "playing catch-up → overwhelm"],
  ["I'm constantly behind on everything I need to do", "", "overwhelm", "constantly behind → overwhelm"],
  ["I'm in such a good place emotionally right now", "", "positive", "in a good place → positive"],
  ["I've got such good vibes about this week", "", "positive", "good vibes → positive"],

  // R150: sadness (can't shake this feeling), shameGuilt (told a lie/white lie), techniques (somatic experiencing), positive (finally did it)
  ["I just can't shake this feeling of sadness", "", "sadness", "can't shake this feeling → sadness"],
  ["I can't shake it off no matter what I do", "", "sadness", "can't shake it off → sadness"],
  ["I told a white lie and feel awful about it", "", "shameGuilt", "white lie → shameGuilt"],
  ["I lied to someone and now I feel terrible", "", "shameGuilt", "lied to someone → shameGuilt"],
  ["I've been learning about somatic experiencing", "", "techniques", "somatic experiencing → techniques"],
  ["I finally did it, I passed my driving test", "", "positive", "finally did it → positive"],
  ["I actually did it and I'm really proud", "", "positive", "i actually did it → positive"],
