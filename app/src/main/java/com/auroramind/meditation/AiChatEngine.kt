...
class AiChatEngine(private val context: Context) {
    ...
    private fun route(lower: String): Pair<String, SoundType?> = when {
        ...
        any(lower, "focus", "study", "concentrat", "productivity",
            ...
            "can't maintain momentum", "can't build momentum",
            "keep starting over", "keep restarting",
        ...
        any(lower, "relax", "calm", "stress", "anxiety", "anxious", "breathe",
            ...
            "paranoid",
            "heart pounding", "pounding heart", "my heart is pounding", "feel paranoid", "feeling paranoid", "paranoia",
        ...
        any(lower, "technique", "breathwork", "breathing", "body scan", "loving-kindness",
            ...
            "diaphragmatic breathing", "belly breathing", "diaphragmatic breath",
        ...
        any(lower, "sad", "grief", "grieving", "heartbreak", "heartbroken",
            ...
            "can't express myself", "don't know how to express",
            "struggle to express my feelings", "can't put my feelings into words",
        ...
        any(lower, "shame", "ashamed", "guilt", "guilty", "i feel guilty",
            ...
            "told a lie", "told a white lie", "white lie", "lied to someone",
            "let myself down", "let people down", "let everyone down",
            "regret", "deep regret", "living with regret", "full of regret",
            "can't stop regretting", "so much regret",
            "cheated in an exam", "cheating in a test", "plagiarism", "plagiarised",
            "cheated at work",
            "lying to my partner", "lying to someone i love",
        ...
        any(lower, "thank", "thanks", "awesome", "perfect",
            ...
            "feel content",
            "things falling into place", "everything coming together", "all coming together", "feeling content", "sense of contentment",
            ...
            "successfully overcame", "feeling blessed", "life is beautiful",
